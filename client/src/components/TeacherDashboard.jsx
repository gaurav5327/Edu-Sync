          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`w-full group flex items-center space-x-3 px-4 py-3 text-sm font-medium rounded-xl transition-all duration-300 ${activeTab === tab.id
                    ? "bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-lg"
                    : "text-gray-600 hover:text-gray-900 hover:bg-gray-100/80"
                  }`}
              >
                <Icon className={`w-5 h-5 transition-transform duration-300 ${activeTab === tab.id ? 'rotate-12' : 'group-hover:rotate-12'
                  }`} />
                <span>{tab.label}</span>
              </button>
            )
                      ...
                      {courses.map((course) => (
                        <tr key={course._id} className="hover:bg-gray-50 transition-colors duration-200">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            <span className={`px-3 py-1 text-xs font-semibold rounded-full ${course.lectureType === "lab"
                                ...
                                {DAYS.map((day) => {
                                  ...
                                  return (
                                    <td
                                      ...
                                      className={`py-3 px-4 border-b border-gray-200 ${slot
